...
export function PopError({Show,Close ,Text}: { Show: boolean, 
    ...
    return <><div
        className={`${Show ? "flex" : "hidden"} absolute w-screen h-screen bg-black opacity-50 flex-col justify-center items-center z-30`}>
    </div> 
        <div className={`${Show ? "flex" : "hidden"} absolute flex flex-col justify-center items-center w-screen h-screen z-30`}>
